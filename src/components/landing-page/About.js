  ...
  return (
    <div className='about-wrapper'>
      ...
      <div className='about-content-wrapper'>
        <h3>About</h3>
        <p>There are many versions of one-dimensional chess. This game uses Glimne's rules, adapted from <a href='https://www.chessvariants.com/shape.dir/onedim.html'>The Chess Variants</a>.</p>
